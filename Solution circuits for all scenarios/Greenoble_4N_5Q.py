...
expected = [(0, 0.25),(14, 0.25),(15, 0.25),(31, 0.25),]
...
def get1L():
	...
	U.ry(0.33983689546585083, 0)
	U.x(0)
	U.append(get2LL().control(1), [0,1,2,3])
	U.x(0)
	U.append(get2LR().control(1), [0,1,2,3])
	return U.to_gate()

def get0():
	U = QuantumCircuit(5, name="0")
	U.ry(-0.5235987901687622, 0)
	U.x(0)
...
def get2LR():
	U = QuantumCircuit(3, name="2LR")
	U.ry(1.5707963705062866, 0)
	U.append(get3LRR(), [1,2])
	return U.to_gate()
